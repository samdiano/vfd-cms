                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-5 border-bottom md-border-right border-left py-3" >
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <h5 class="cursor font-weight-bold mt-3 text-md-left text-center" data-toggle="modal" data-target="#{{$director->id}}">{{$director->name}}</h5>
                                                ...
                                                <div class="modal fade" id="{{$director->id}}" tabindex="-1" role="dialog" aria-labelledby="exec_infoLabel"
                                                aria-hidden="true">
