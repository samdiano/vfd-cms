...
<body>
    ...
    <!--/.Navbar-->
    <div class="position-relative about_top_banner" style="background-image: url({{ asset($banner->contact) }}">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="col-md-5">
                <form method="post" action="{{url('contact_us')}}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control text-area" id="message" name="message" rows="3"
                            style=""></textarea>
                    </div>
