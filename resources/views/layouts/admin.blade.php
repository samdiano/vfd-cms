...
<head>
    ...
    <![endif]-->
    <script src="https://cdn.tiny.cloud/1/92iapb5hpv4b03x6b71ddi2l0dzs9x1stzcdrt5096d34nwg/tinymce/5/tinymce.min.js"></script>
    <script>
        tinymce.init({
  selector: 'textarea',
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="email" class="form-control" id="clientEmail"
                                                               ...
                                                               placeholder="admin@driverng.com">
