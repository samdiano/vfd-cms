    ...
    <body>
        ...
        <div class="bg-board-detail vertical-4">
            <div class="container-fluid mx-md-5">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="text-green gotham-bold my-4 font-weight-bold"> <a href="{{ url()->previous().'?sub=subsidiary-just' }}"><i class="fa fa-angle-left text-dark mr-5"></i></a> Board of Directors</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid mx-md-5">
            <div class="row mt-5">
                ...
                <div class="col-md-6">
                    <h5 class="font-weight-bold text-md-left text-center" data-toggle="modal" data-target="#{{$profile->name}}">{{$profile->name}}</h5>
