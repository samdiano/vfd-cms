        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs nav-justified md-tabs mb-3" id="investor_tab" role="tablist">
                <li class="nav-item waves-effect waves-light">
                    <a class="nav-link active small-md" id="finance-tab-just" data-toggle="tab" href="#finance-just" role="tab" aria-controls="finance-just" aria-selected="true">Financial Information</a>
                </li>

                <li class="nav-item waves-effect waves-light">
                    <a class="nav-link small-md" id="conference-tab-just" data-toggle="tab" href="#conference-just" role="tab" aria-controls="conference-just" aria-selected="true">Conference Calls</a>
                </li>

                <li class="nav-item waves-effect waves-light">
                    <a class="nav-link small-md" id="press-tab-just" data-toggle="tab" href="#press-just" role="tab" aria-controls="press-just" aria-selected="true">Press Release</a>
                </li>

                <li class="nav-item waves-effect waves-light">
                    <a class="nav-link small-md" id="faq-tab-just" data-toggle="tab" href="#faq-just" role="tab" aria-controls="faq-just" aria-selected="true">FAQs</a>
                </li>
            </ul>
                ...
                <div class="tab-pane fade active show" id="finance-just" role="tabpanel" aria-labelledby="finance-tab-just">
                    <div class="accordion md-accordion" id="finance" role="tablist" aria-multiselectable="true">
                        <div class="card my-3 border-0">
                            ...
                            <div id="finance1" class="collapse show mb-2" role="tabpanel" aria-labelledby="finance_heading_1"
                                 data-parent="#finance">
            ...
            <div class="tab-pane fade" id="conference-just" role="tabpanel" aria-labelledby="conference-tab-just">
                    ...
                    <div class="accordion md-accordion" id="conference" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="card my-3 border-0">
                            ...
                            <div id="conference1" class="collapse show mb-2" role="tabpanel" aria-labelledby="conference_heading_1"
