    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        <a class="btn btn-primary" href="{{ url('admin/conference/new') }}">Add Conference Call</a>
                        <div class="table-rep-plugin">
                            <div class="table-responsive" data-pattern="priority-columns">
                                {{-- @include('partial.alert') --}}
                                @if(count($info) < 1) <br><br>
                                    <div class="alert alert-info text-center">
                                        <p>There are no conference calls provided at the moment</p>
                                    </div>
                                    @else
                                    <br><br>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info"
                                                        href="{{ url('admin/conference/edit', ['id' => $info->id]) }}">Edit</a>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="text-center">
                                                                ...
                                                                <div class="xs-mt-50">
                                                                    ...
                                                                    <a href="{{ url('admin/conference/delete', ['id' => $info->id])}}"
