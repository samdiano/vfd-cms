                                ...
                                @if(count($info) < 1) <br><br>
                                    ...
                                    <table id="tech-companies-1" class="table  table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $info->title }}</td>
                                                <td><img height="300" width="300" src="{{ asset($info->image_path) }}"
                                                ...
                                                <td>
                                                    ...
                                                    --}}
                                                    <a class="btn btn-info" href="{{ url('admin/blog/edit', ['id' => $info->id]) }}">Edit</a>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="text-center">
                                                                ...
                                                                <div class="xs-mt-50">
                                                                    ...
                                                                    <a href="{{ url('admin/blog/delete', ['id' => $info->id])}}"
