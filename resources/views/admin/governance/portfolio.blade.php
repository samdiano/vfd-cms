                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                ...
                                @if(count($info) < 1) <br><br>
                                    <div class="alert alert-info text-center">
                                        <p>There are no Head of portfolios posted at the moment</p> <a class="btn btn-primary" href="{{ url('admin/governance/new') }}">Click here to add Profile</a>
                                    </div>
                                    @else
                                    <br><br>
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        --}}
                                                    <a class="btn btn-info" href="{{ url('admin/governance/portfolios/edit', ['id' => $info->id]) }}">Edit</a>
