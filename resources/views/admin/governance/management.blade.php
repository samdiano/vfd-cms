                                ...
                                <div class="table-responsive" data-pattern="priority-columns">
                                    ...
                                    @if(count($info) < 1)
                                        ...
                                        <div class="alert alert-info text-center">
                                            <p>There are no management members posted at the moment</p>
                                        </div>
                                    @else
                                        <br><br>
                                        <table id="tech-companies-1" class="table  table-striped">
                                            ...
                                            @foreach($info as $info)
                                                <tr>
                                                    <td>{{ $info->name }}</td>
                                                    <td><img height="200" width="200" src="{{ asset($info->image) }}" class="img-fluid position-absolute global-image-subtract d-none d-md-block" /></td>
