                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                ...
                                @if(count($info) < 1) <br><br>
                                    <div class="alert alert-info text-center">
                                        <p>There are no management members posted at the moment</p> <a class="btn btn-primary" href="{{ url('admin/governance/new') }}">Click here to add Profile</a>
                                    </div>
                                    @else
                                    <br><br>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="text-center">
                                                                    ...
                                                                    <div class="xs-mt-50">
                                                                        ...
                                                                        <a href="{{ url('admin/governance/management/delete', ['id' => $info->id])}}"
