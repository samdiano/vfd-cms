    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        <a class="btn btn-primary" href="{{ url('admin/financial-information/new') }}">Add Financial
                            Information</a>
                                ...
                                @if(count($info) < 1) <br><br>
                                    ...
                                    <table id="tech-companies-1" class="table  table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $info->title }}</td>
                                                <td><img width="200" src="{{ asset($info->image_path) }}"
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info"
                                                        href="{{ url('admin/financial-information/edit',['id' => $info->id]) }}">Edit</a>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="text-center">
                                                                ...
                                                                <div class="xs-mt-50">
                                                                    ...
                                                                    <a href="{{ url('admin/financial-information/delete',['id' => $info->id])}}"
