                ...
                <div class="col-md-9">
                    <ul class="nav nav-tabs nav-justified md-tabs mb-3 mt-3 media-margin" id="blogTab" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link active small-md" id="vacancies-tab-just" data-toggle="tab" href="#vacancies-just" role="tab" aria-controls="vacancies-just" aria-selected="true">Blog</a>
                        </li>

                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link small-md" id="portfolios-tab-just" data-toggle="tab" href="#portfolios-just" role="tab" aria-controls="portfolios-just" aria-selected="true">Gallery</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade" id="portfolios-just" role="tabpanel" aria-labelledby="portfolios-tab-just">
                            <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="card my-3 border-0">
                                    ...
                                    <div id="collapseOne1" class="collapse show my-4" role="tabpanel" aria-labelledby="headingOne1"
