						...
						function t(t) {
							...
							if ("scroll" === M) {
								...
								for (var O in a(r).tweensContainer && !0 === a(r).isAnimating && (D = a(r).tweensContainer), u.each(y, function (t, e) {
									...
									var z = b.Hooks.getRoot(O)
										, V = !1;
									if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
										(c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(O) && !N && 0 !== W && (N = 0), c._cacheValues && D && D[O] ? (N === n && (N = D[O].endValue + D[O].unitType), V = a(r).rootPropertyValueCache[z]) : b.Hooks.registered[O] ? N === n ? (V = b.getPropertyValue(r, z), N = b.getPropertyValue(r, O, V)) : V = b.Hooks.templates[z][1] : N === n && (N = b.getPropertyValue(r, O));
										var B, j, Y, $ = !1;
										if (N = (B = p(O, N))[0], Y = B[1], W = (B = p(O, W))[0].replace(/^([+-\/*])=/, function (t, e) {
												return $ = e, ""
											}), j = B[1], N = parseFloat(N) || 0, W = parseFloat(W) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (W /= 100, j = "em") : /^scale/.test(O) ? (W /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (W = W / 100 * 255, j = "")), /[\/*]/.test($)) j = Y;
										else if (Y !== j && 0 !== N)
											if (0 === W) j = Y;
											else {
												o = o || m();
												...
												switch (Y) {
												case "%":
													N *= "x" === X ? o.percentToPxWidth : o.percentToPxHeight;
													break;
												case "px":
													break;
												default:
												...
												switch (j) {
												case "%":
													N *= 1 / ("x" === X ? o.percentToPxWidth : o.percentToPxHeight);
													break;
												case "px":
													break;
												default:
							...
							d.element && (b.Values.addClass(r, "velocity-animating"), F.push(d), "" === c.queue && (a(r).tweensContainer = d, a(r).opts = c), a(r).isAnimating = !0, S === C - 1 ? (v.State.calls.push([F, g, c, null, I.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : S++)
						}
						var o, r = this
					...
					if (f.isWrapped(this) ? (d = !1, p = 0, g = this, h = this) : (d = !0, p = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
						...
						if (u.each(g, function (t, e) {
							...
							for (var R = 0; E > R; R++) {
								...
								R === E - 1 && (W.display = O.display, W.visibility = O.visibility, W.complete = O.complete), x(g, "reverse", W)
							}
						return t()
					}
				};
				...
				n._set("bar", {
					...
					t.controllers.bar = t.DatasetController.extend({
						...
						, getRuler: function () {
							...
							for (t = 0, e = this.getMeta().data.length; t < e; ++t) a.push(i.getPixelForValue(null, t, o));
							return {
								pixels: a
								, start: s
								, end: l
						...
						, calculateBarIndexPixels: function (t, e, i) {
							var n, o, r, s, l, c = i.scale.options
								...
								, p = i.start
								, m = i.end;
							return 1 === f ? (n = h > p ? h - p : m - h, o = h < m ? m - h : h - p) : (e > 0 && (n = (h - d[e - 1]) / 2, e === f - 1 && (o = n)), e < f - 1 && (o = (d[e + 1] - h) / 2, 0 === e && (n = o))), l = (s = ((r = n * c.categoryPercentage) + o * c.categoryPercentage) / i.stackCount) * c.barPercentage, h -= r, h += s * u, {
								size: l = Math.min(a.valueOrDefault(c.barThickness, l), a.valueOrDefault(c.maxBarThickness, 1 / 0))
								, base: h += (s - l) / 2
								, head: h + l
								, center: h + l / 2
							}
					...
					t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
						construct: function (e, i) {
							...
							var s = r.acquireContext(e, i)
								...
								, c = l && l.height
								, u = l && l.width;
							a.id = o.uid(), a.ctx = s, a.canvas = l, a.config = i, a.width = u, a.height = c, a.aspectRatio = c ? u / c : null, a.options = i.options, a._bufferedRender = !1, a.chart = a, a.controller = a, t.instances[a.id] = a, Object.defineProperty(a, "data", {
								get: function () {
						...
						, initialize: function () {
							var t = this;
							return e.notify(t, "beforeInit"), o.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildScales(), t.initToolTip(), e.notify(t, "afterInit"), t
						}
						, clear: function () {
						...
						, resize: function (t) {
							var i = this
								...
								, s = Math.max(0, Math.floor(o.getMaximumWidth(a)))
								, l = Math.max(0, Math.floor(r ? s / r : o.getMaximumHeight(a)));
							if ((i.width !== s || i.height !== l) && (a.width = i.width = s, a.height = i.height = l, a.style.width = s + "px", a.style.height = l + "px", o.retinaScale(i, n.devicePixelRatio), !t)) {
								var c = {
									width: s
									, height: l
								};
								e.notify(i, "resize", [c]), i.options.onResize && i.options.onResize(i, c), i.stop(), i.update(i.options.responsiveAnimationDuration)
							}
						}
						...
						, buildScales: function () {
							...
							n.scales && (r = r.concat((n.scales.xAxes || []).map(function (t) {
								...
								if (l) {
									...
									a[c.id] = c, c.mergeTicksOptions(), n.isDefault && (e.scale = c)
								}
						...
						, buildOrUpdateControllers: function () {
							...
							return o.each(e.data.datasets, function (o, a) {
								...
								if (r.type && r.type !== s && (e.destroyDatasetMeta(a), r = e.getDatasetMeta(a)), r.type = s, i.push(r.type), r.controller) r.controller.updateIndex(a);
								else {
						...
						, update: function (t) {
							...
							if (t && "object" == typeof t || (t = {
									duration: t
									, lazy: arguments[1]
								}), (n = (i = a).options).scale ? i.scale.options = n.scale : n.scales && n.scales.xAxes.concat(n.scales.yAxes).forEach(function (t) {
									i.scales[t.id].options = t
								}), i.tooltip._options = n.tooltips, !1 !== e.notify(a, "beforeUpdate")) {
								...
								}, a), a.updateLayout(), o.each(r, function (t) {
									t.reset()
								}), a.updateDatasets(), a.tooltip.initialize(), a.lastActive = [], e.notify(a, "afterUpdate"), a._bufferedRender ? a._bufferedRequest = {
									duration: t.duration
									, easing: t.easing
									, lazy: t.lazy
								} : a.render(t)
						...
						, render: function (i) {
							...
							if (!1 !== e.notify(n, "beforeRender")) {
								var s = n.options.animation
									, l = function (t) {
										e.notify(n, "afterRender"), o.callback(s && s.onComplete, [t], n)
									};
								if (s && (void 0 !== a && 0 !== a || void 0 === a && 0 !== s.duration)) {
									var c = new t.Animation({
										numSteps: (a || s.duration) / 16.66
									...
									t.animationService.addAnimation(n, c, a, r)
								}
						...
						, draw: function (t) {
							var i = this;
							i.clear(), o.isNullOrUndef(t) && (t = 1), i.transition(t), !1 !== e.notify(i, "beforeDraw", [t]) && (o.each(i.boxes, function (t) {
								t.draw(i.chartArea)
						...
						, drawDataset: function (t, i) {
							...
							!1 !== e.notify(this, "beforeDatasetDraw", [o]) && (n.controller.draw(i), e.notify(this, "afterDatasetDraw", [o]))
						}
						...
						, destroy: function () {
							var i, n, a = this
								, s = a.canvas;
							for (a.stop(), i = 0, n = a.data.datasets.length; i < n; ++i) a.destroyDatasetMeta(i);
							s && (a.unbindEvents(), o.canvas.clear(a), r.releaseContext(a.ctx), a.canvas = null, a.ctx = null), e.notify(a, "destroy"), delete t.instances[a.id]
						}
						...
						, eventHandler: function (t) {
							...
							if (!1 !== e.notify(i, "beforeEvent", [t])) {
								...
								var o = i.handleEvent(t);
								o |= n && n.handleEvent(t), e.notify(i, "afterEvent", [t]);
								var a = i._bufferedRequest;
								return a ? i.render(a) : o && !i.animating && (i.stop(), i.render(i.options.hover.animationDuration, !0)), i._bufferedRender = !1, i._bufferedRequest = null, i
							}
						}
					...
					a.configMerge = function () {
						...
						if (1 !== i) {
							var n = t.canvas
								, o = t.height
								, a = t.width;
							n.height = o * i, n.width = a * i, t.ctx.scale(i, i), n.style.height = o + "px", n.style.width = a + "px"
						}
						...
						, update: function (t, o, a) {
							if (t) {
								var r = t.options.layout || {}
									...
									, p = e(t.boxes, "top")
									, m = e(t.boxes, "bottom")
									, g = e(t.boxes, "chartArea");
								i(h, !0), i(f, !1), i(p, !0), i(m, !1);
								var v = o - l - c
									, y = a - u - d
									, b = y / 2
									, x = (o - v / 2) / (h.length + f.length)
									, w = (a - b) / (p.length + m.length)
									, k = v
									, C = y
									, S = [];
								n.each(h.concat(f, p, m), function (t) {
									var e, i = t.isHorizontal();
									i ? (e = t.update(t.fullWidth ? v : k, w), C -= e.height) : (e = t.update(x, b), k -= e.width), S.push({
										horizontal: i
										, minSize: e
										, box: t
									})
								...
								n.each(h.concat(f), N), n.each(h, function (t) {
									...
									D += t.width
								}), n.each(p.concat(m), N), n.each(p, function (t) {
									_ += t.height
								}), n.each(m, function (t) {
									E += t.height
								}), n.each(h.concat(f), function (t) {
								...
								var W = l + O
									, H = u + L;
								n.each(h.concat(p), z), W += k, H += C, n.each(f, z), n.each(m, z), t.chartArea = {
									left: A
									, top: _
									, right: A + k
									, bottom: _ + C
							...
							function z(t) {
								t.isHorizontal() ? (t.left = t.fullWidth ? l : A, t.right = t.fullWidth ? o - c : A + k, t.top = H, t.bottom = H + t.height, H = t.bottom) : (t.left = W, t.right = W + t.width, t.top = _, t.bottom = _ + C, W = t.right)
							}
						}
					}
				}
						...
						, draw: function (t) {
							...
							if (o.display) {
								var s = e.ctx
									...
									, M = []
									, I = "right" === o.position ? e.left : e.right - w
									, P = "right" === o.position ? e.left + w : e.right
									, A = "bottom" === o.position ? e.top : e.bottom - w
									, D = "bottom" === o.position ? e.top + w : e.bottom;
								if (a.each(g, function (i, n) {
										if (!a.isNullOrUndef(i.label)) {
											var r, s, d, f, v, y, b, x, k, C, S, _, E, O, L = i.label;
											...
											if (m) {
												var H = w + W;
												"bottom" === o.position ? (R = p ? "middle" : "top", F = p ? "right" : "center", O = e.top + H) : (R = p ? "middle" : "bottom", F = p ? "left" : "center", O = e.bottom - H);
												var N = l(e, n, h.offsetGridLines && g.length > 1);
												N < e.left && (s = "rgba(0,0,0,0)"), N += a.aliasPixel(r), E = e.getPixelForTick(n) + u.labelOffset, v = b = k = S = N, y = A, x = D, C = t.top, _ = t.bottom
											}
											else {
												var z, V = "left" === o.position;
												u.mirror ? (F = V ? "left" : "right", z = W) : (F = V ? "right" : "left", z = w + W), E = V ? e.right - z : e.left + z;
												var B = l(e, n, h.offsetGridLines && g.length > 1);
												B < e.top && (s = "rgba(0,0,0,0)"), B += a.aliasPixel(r), O = e.getPixelForTick(n) + u.labelOffset, v = I, b = P, k = t.left, S = t.right, y = x = C = _ = B
											}
											M.push({
												tx1: v
												, ty1: y
										...
										if (h.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), u.display) {
											...
											var e = t.label;
											if (a.isArray(e))
												for (var i = 0, n = 0; i < e.length; ++i) s.fillText("" + e[i], 0, n), n += 1.5 * y.size;
									...
									var _, E, O = 0
										, L = r(f) / 2;
									if (m) _ = e.left + (e.right - e.left) / 2, E = "bottom" === o.position ? e.bottom - L - S.bottom : e.top + L + S.top;
									else {
										var F = "left" === o.position;
										_ = F ? e.left + L + S.top : e.right - L - S.top, E = e.top + (e.bottom - e.top) / 2, O = F ? -.5 * Math.PI : .5 * Math.PI
									}
									s.save(), s.translate(_, E), s.rotate(O), s.textAlign = "center", s.textBaseline = "middle", s.fillStyle = k, s.font = C.font, s.fillText(f.labelString, 0, 0), s.restore()
								}
								if (h.drawBorder) {
									...
									var R = e.left
										...
										, H = e.top
										, N = e.bottom
										, z = a.aliasPixel(s.lineWidth);
									m ? (H = N = "top" === o.position ? e.bottom : e.top, H += z, N += z) : (R = W = "left" === o.position ? e.right : e.left, R += z, W += z), s.beginPath(), s.moveTo(R, H), s.lineTo(W, N), s.stroke()
								}
							}
						}
					})
				...
				e.exports = {
					generators: {
						linear: function (t, e) {
							...
							var l = (s - r) / i;
							l = n.almostEquals(l, Math.round(l), i / 1e3) ? Math.round(l) : Math.ceil(l), o.push(void 0 !== t.min ? t.min : r);
							for (var c = 1; c < l; ++c) o.push(r + c * i);
					...
					t.Tooltip = o.extend({
						...
						, update: function (e) {
							...
							if (m.length) {
								...
								}), p.title = d.getTitle(C, g), p.beforeBody = d.getBeforeBody(C, g), p.body = d.getBody(C, g), p.afterBody = d.getAfterBody(C, g), p.footer = d.getFooter(C, g), p.x = Math.round(x.x), p.y = Math.round(x.y), p.caretPadding = h.caretPadding, p.labelColors = w, p.labelTextColors = k, p.dataPoints = C, y = function (t, e, i) {
									var n = t.x
										, o = t.y
										, a = t.caretSize
										, r = t.caretPadding
										...
										, u = a + r
										, d = s + r;
									return "right" === l ? n -= e.width : "center" === l && (n -= e.width / 2), "top" === c ? o += u : o -= "bottom" === c ? e.height + u : e.height / 2, "center" === c ? "left" === l ? n += u : "right" === l && (n -= u) : "left" === l ? n -= d : "right" === l && (n += d), {
										x: n
										, y: o
									}
								}(p, b = function (t, e) {
						...
						, getCaretPosition: function (t, e, i) {
							...
							else if ("left" === d ? (n = (o = f + u + c) - c, a = o + c) : "right" === d ? (n = (o = f + m - u - c) - c, a = o + c) : (n = (o = f + m / 2) - c, a = o + c), "top" === h) s = (r = p) - c, l = r;
							else {
								s = (r = p + g) + c, l = r;
								var v = a;
								a = n, n = v
						...
						, handleEvent: function (t) {
							var e = this
								, i = e._options
								, n = !1;
							if (e._lastActive = e._lastActive || [], "mouseout" === t.type ? e._active = [] : e._active = e._chart.getElementsAtEventForMode(t, i.mode, i), !(n = !a.arrayEquals(e._active, e._lastActive))) return !1;
				...
				n._set("global", {
					...
					return {
						...
						, afterDatasetsUpdate: function (t, n) {
							var a, l, c, u, d = (t.data.datasets || []).length
								, h = n.propagate
								, f = [];
							for (l = 0; l < d; ++l) u = null, (c = (a = t.getDatasetMeta(l)).dataset) && c._model && c instanceof o.Line && (u = {
								visible: t.isDatasetVisible(l)
								, fill: e(c, l, d)
								, chart: t
								, el: c
							}), a.$filler = u, f.push(u);
							for (l = 0; l < d; ++l)(u = f[l]) && (u.fill = r(f, l, h), u.boundary = i(u), u.mapper = s(u))
						}
						, beforeDatasetDraw: function (t, e) {
							...
							if (i) {
								...
								d && h && u.length && (a.canvas.clipArea(o, t.chartArea), function (t, e, i, n, o, a) {
									var r, s, u, d, h, f, p, m = e.length
										, g = n.spanGaps
										, v = []
										, y = []
										, b = 0
										, x = 0;
									for (t.beginPath(), r = 0, s = m + !!a; r < s; ++r) h = i(d = e[u = r % m]._view, u, n), f = l(d), p = l(h), f && p ? (b = v.push(d), x = y.push(h)) : b && x && (g ? (f && v.push(d), p && y.push(h)) : (c(t, v, y, b, x), b = x = 0, v = [], y = []));
									c(t, v, y, b, x), t.closePath(), t.fillStyle = o, t.fill()
								}(o, u, d, s, h, r._loop), a.canvas.unclipArea(o))
							}
						}
					}
				}
			...
			, 50: [function (t, e, i) {
				...
				n._set("global", {
					...
					function s(i, n) {
						...
						e.configure(i, o, n), e.addBox(i, o), i.legend = o
					}
					return t.Legend = o.extend({
						...
						, fit: function () {
							var t = this
								...
								, l = n.global
								, c = a.valueOrDefault
								, u = c(i.fontSize, l.defaultFontSize)
								, d = c(i.fontStyle, l.defaultFontStyle)
								, h = c(i.fontFamily, l.defaultFontFamily)
							...
							if (g ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o)
								if (s.font = f, g) {
									...
									s.textAlign = "left", s.textBaseline = "top", a.each(t.legendItems, function (e, n) {
										var o = r(i, u) + u / 2 + s.measureText(e.text).width;
									...
									a.each(t.legendItems, function (t, e) {
										var n = r(i, u) + u / 2 + s.measureText(t.text).width;
						...
						, draw: function () {
							...
							if (e.display) {
								...
								var w = p + i.padding;
								a.each(t.legendItems, function (n, r) {
									var f = d.measureText(n.text).width
										, m = y + p / 2 + f
										, g = u.x
										, v = u.y;
									x ? g + m >= l && (v = u.y += w, u.line++, g = u.x = t.left + (l - c[u.line]) / 2) : v + w > t.bottom && (g = u.x = g + t.columnWidths[u.line] + i.padding, v = u.y = t.top + i.padding, u.line++)
										, function (t, i, n) {
											if (!(isNaN(y) || y <= 0)) {
												...
												if (d.setLineDash && d.setLineDash(h(n.lineDash, s.borderDash)), e.labels && e.labels.usePointStyle) {
												...
												else r || d.strokeRect(t, i, y, p), d.fillRect(t, i, y, p);
												d.restore()
											}
										}(g, v, n), b[r].left = g, b[r].top = v
										, function (t, e, i, n) {
											var o = p / 2
												, a = y + o + t
												, r = e + o;
						...
						, beforeUpdate: function (t) {
							var i = t.options.legend
								, o = t.legend;
							i ? (a.mergeIf(i, n.global.legend), o ? (e.configure(t, o, i), o.options = i) : s(t, i)) : o && (e.removeBox(t, o), delete t.legend)
						}
			...
			, 51: [function (t, e, i) {
				...
				n._set("global", {
					...
					function r(i, n) {
						...
						e.configure(i, o, n), e.addBox(i, o), i.titleBlock = o
					}
					return t.Title = o.extend({
						...
						, beforeUpdate: function (i) {
							var o = i.options.title
								, s = i.titleBlock;
							o ? (a.mergeIf(o, n.global.title), s ? (e.configure(i, s, o), s.options = o) : r(i, o)) : s && (t.layoutService.removeBox(i, s), delete i.titleBlock)
						}
					}
				}
			}, {
						...
						, i = t.LinearScaleBase.extend({
							...
							, getPixelForValue: function (t) {
								var e, i = this
									...
									, o = +i.getRightValue(t)
									, a = i.end - n;
								return i.isHorizontal() ? (e = i.left + i.width / a * (o - n), Math.round(e)) : (e = i.bottom - i.height / a * (o - n), Math.round(e))
							}
							, getValueForPixel: function (t) {
								var e = this
									, i = e.isHorizontal()
					...
					t.LinearScaleBase = t.Scale.extend({
						...
						, buildTicks: function () {
							var t = this
								...
								, r = t.ticks = o.generators.linear(a, t);
					...
					var e = {
						...
						, i = t.Scale.extend({
							determineDataLimits: function () {
								...
								var c = e.stacked;
								if (void 0 === c && n.each(a, function (t, e) {
										if (!c) {
											var i = o.getDatasetMeta(e);
											o.isDatasetVisible(e) && l(i) && void 0 !== i.stack && (c = !0)
										}
									}), e.stacked || c) {
									var u = {};
									n.each(a, function (i, a) {
										var r = o.getDatasetMeta(a)
											, s = [r.type, void 0 === e.stacked && void 0 === r.stack ? a : "", r.stack].join(".");
										o.isDatasetVisible(a) && l(r) && (void 0 === u[s] && (u[s] = []), n.each(i.data, function (i, n) {
											var o = u[s]
												, a = +t.getRightValue(i);
											isNaN(a) || r.data[n].hidden || (o[n] = o[n] || 0, e.relativePoints ? o[n] = 100 : o[n] += a)
										}))
									}), n.each(u, function (e) {
										var i = n.min(e)
											, o = n.max(e);
								...
								else n.each(a, function (e, i) {
									var a = o.getDatasetMeta(i);
									o.isDatasetVisible(i) && l(a) && n.each(e.data, function (e, i) {
										var n = +t.getRightValue(e);
										isNaN(n) || a.data[i].hidden || (null === t.min ? t.min = n : n < t.min && (t.min = n), null === t.max ? t.max = n : n > t.max && (t.max = n), 0 !== n && (null === t.minNotZero || n < t.minNotZero) && (t.minNotZero = n))
									})
								});
							...
							, buildTicks: function () {
								var t = this
									...
									, a = t.ticks = o.generators.logarithmic(i, t);
								t.isHorizontal() || a.reverse(), t.max = n.max(a), t.min = n.min(a), e.reverse ? (a.reverse(), t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max)
							}
							, convertTicksToLabels: function () {
							...
							, getPixelForValue: function (t) {
								var e, i, o, a = this
									...
									, s = +a.getRightValue(t)
									, l = a.options.ticks;
								return a.isHorizontal() ? (o = n.log10(a.end) - n.log10(r), 0 === s ? i = a.left : (e = a.width, i = a.left + e / o * (n.log10(s) - n.log10(r)))) : (e = a.height, 0 !== r || l.reverse ? 0 === a.end && l.reverse ? (o = n.log10(a.start) - n.log10(a.minNotZero), i = s === a.end ? a.top : s === a.minNotZero ? a.top + .02 * e : a.top + .02 * e + .98 * e / o * (n.log10(s) - n.log10(a.minNotZero))) : 0 === s ? i = l.reverse ? a.top : a.bottom : (o = n.log10(a.end) - n.log10(r), e = a.height, i = a.bottom - e / o * (n.log10(s) - n.log10(r))) : (o = n.log10(a.end) - n.log10(a.minNotZero), i = s === r ? a.bottom : s === a.minNotZero ? a.bottom - .02 * e : a.bottom - .02 * e - .98 * e / o * (n.log10(s) - n.log10(a.minNotZero)))), i
							}
							, getValueForPixel: function (t) {
								var e, i, o = this
									, a = n.log10(o.end) - n.log10(o.start);
								return o.isHorizontal() ? (i = o.width, e = o.start * Math.pow(10, (t - o.left) * a / i)) : (i = o.height, e = Math.pow(10, (o.bottom - t) * a / i) / o.start), e
							}
						});
						...
						, draw: function () {
							...
							if (i.display) {
								...
								o.each(t.ticks, function (i, s) {
									...
									var f = t.getDistanceFromCenterForValue(a.ticks.reverse ? t.min : t.max)
										, p = s(t);
									i.textBaseline = "top";
									for (var m = r(t) - 1; m >= 0; m--) {
										if (l.display) {
											var g = t.getPointPosition(m, f);
											i.beginPath(), i.moveTo(t.xCenter, t.yCenter), i.lineTo(g.x, g.y), i.stroke(), i.closePath()
										}
										if (h.display) {
											var v = t.getPointPosition(m, f + 5)
												, y = n(h.fontColor, e.defaultFontColor);
											i.font = p.font, i.fillStyle = y;
											var b = t.getIndexAngle(m)
												, x = o.toDegrees(b);
											i.textAlign = c(x), d(x, t._pointLabelSizes[m], v), u(i, t.pointLabels[m] || "", v, p.size)
										}
									}
								}(t)
							}
				...
				e.exports = function (t) {
					var e = t.Scale.extend({
							...
							for (t = 0, i = (f.data.datasets || []).length; t < i; ++t)
								if (f.isDatasetVisible(t))
									if (l = f.data.datasets[t].data, a.isObject(l[0]))
										for (b[t] = [], e = 0, o = l.length; e < o; ++e) c = p(l[e], h), y.push(c), b[t][e] = c;
									else y.push.apply(y, x), b[t] = x.slice(0);
							else b[t] = [];
							x.length && (x = d(x).sort(u), g = Math.min(g, x[0]), v = Math.max(v, x[x.length - 1])), y.length && (y = d(y).sort(u), g = Math.min(g, y[0]), v = Math.max(v, y[y.length - 1])), g = p(m.min, h) || g, v = p(m.max, h) || v, g = g === s ? +n().startOf("day") : g, v = v === r ? +n().endOf("day") + 1 : v, h.min = Math.min(g, v), h.max = Math.max(g + 1, v), h._horizontal = h.isHorizontal(), h._table = [], h._timestamps = {
								data: y
								, datasets: b
								, labels: x
							}
						...
						, buildTicks: function () {
							...
							for ("ticks" === s.bounds && d.length && (a = d[0], r = d[d.length - 1]), a = p(u.min, o) || a, r = p(u.max, o) || r, t = 0, e = d.length; t < e; ++t)(i = d[t]) >= a && i <= r && f.push(i);
							return o.min = a, o.max = r, o._unit = u.unit || function (t, e, i, o) {
								...
								}(f, u.minUnit, o.min, o.max), o._majorUnit = m(o._unit), o._table = function (t, e, i, n) {
						...
						, getLabelForIndex: function (t, e) {
							...
							return a.isObject(r) && (o = this.getRightValue(r)), n.tooltipFormat && (o = f(o, n).format(n.tooltipFormat)), o
						}
...
$(window).scroll(function () {
	...
	, function (t, e) {
		...
		var l = {
				...
				, hide: function (t, e) {
					for (var i = (e = e || this).getElementsByClassName("waves-rippling"), n = 0, o = i.length; n < o; n++) u(t, e, i[n])
				}
			}
			, c = {
				input: function (t) {
			...
			if (null !== e) {
				...
				if (d.registerEvent(t), "touchstart" === t.type && l.delay) {
					var i = !1
						...
						, a = function (n) {
							o && (clearTimeout(o), o = null, l.show(t, e)), i || (i = !0, l.hide(n, e))
						};
					e.addEventListener("touchmove", function (t) {
						o && (clearTimeout(o), o = null), a(t)
					}, !1), e.addEventListener("touchend", a, !1), e.addEventListener("touchcancel", a, !1)
				}
...
dropdownSelectors.on({
	...
	, function (t, e, i, n) {
				...
				, function (t, e) {
					...
					e.timeStamp = u(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = nt(l, d), e.distance = it(l, d)
						, function (t, e) {
							var i = e.center
								...
								, o = t.prevDelta || {}
								, a = t.prevInput || {};
							e.eventType !== R && a.eventType !== H || (o = t.prevDelta = {
								x: a.deltaX || 0
								, y: a.deltaY || 0
							}, n = t.offsetDelta = {
								x: i.x
					...
					e.overallVelocityX = h.x, e.overallVelocityY = h.y, e.overallVelocity = c(h.x) > c(h.y) ? h.x : h.y, e.scale = s ? (f = s.pointers, p = o, it(p[0], p[1], Q) / it(f[0], f[1], Q)) : 1, e.rotation = s ? function (t, e) {
						...
						, function (t, e) {
							...
							if (e.eventType != N && (l > F || s.velocity === n)) {
		...
		function et(t, e) {
			return t === e ? z : c(t) >= c(e) ? t < 0 ? V : B : e < 0 ? j : Y
		}
		...
		v(st, Z, {
			handler: function (t) {
				var e = ot[t.type];
				e & R && 0 === t.button && (this.pressed = !0), e & W && 1 !== t.which && (e = H), this.pressed && (e & H && (this.pressed = !1), this.callback(this.manager, e, {
					pointers: [t]
					, changedPointers: [t]
					, pointerType: "mouse"
					, srcEvent: t
		...
		t.MSPointerEvent && !t.PointerEvent && (ut = "MSPointerDown", dt = "MSPointerMove MSPointerUp MSPointerCancel"), v(ht, Z, {
			handler: function (t) {
				...
				o & R && (0 === t.button || r) ? s < 0 && (e.push(t), s = e.length - 1) : o & (H | N) && (i = !0), s < 0 || (e[s] = t, this.callback(this.manager, o, {
					pointers: e
					, changedPointers: [t]
					, pointerType: a
					, srcEvent: t
			...
			handler: function (t) {
				...
				if (e === R && (this.started = !0), this.started) {
					var i = function (t, e) {
						...
						e & (H | N) && (i = P(i.concat(n), "identifier", !0));
						return [i, n]
					}.call(this, t, e);
					e & (H | N) && i[0].length - i[1].length == 0 && (this.started = !1), this.callback(this.manager, e, {
						pointers: i[0]
						, changedPointers: i[1]
						, pointerType: "touch"
						, srcEvent: t
			...
			handler: function (t) {
				var e = vt[t.type]
					, i = function (t, e) {
						var i = I(t.touches)
							, n = this.targetIds;
						if (e & (R | W) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
						...
						o = 0;
						for (; o < r.length;) n[r[o].identifier] && s.push(r[o]), e & (H | N) && delete n[r[o].identifier], o++;
						if (!s.length) return;
		...
		v(kt, Z, {
			handler: function (t, e, i) {
				...
				if (!(o && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
					if (n)(function (t, e) {
						t & R ? (this.primaryTouch = e.changedPointers[0].identifier, Ct.call(this, e)) : t & (H | N) && Ct.call(this, e)
					}).call(this, e, i);
		...
		function zt(t) {
			return t & Ht ? "cancel" : t & Rt ? "end" : t & Ft ? "move" : t & Lt ? "start" : ""
		}

		function Vt(t) {
			return t == Y ? "down" : t == j ? "up" : t == V ? "left" : t == B ? "right" : ""
		}
		...
		Nt.prototype = {
			...
			, emit: function (t) {
				...
				i < Rt && n(e.options.event + zt(i)), n(e.options.event), t.additionalEvent && n(t.additionalEvent), i >= Rt && n(e.options.event + zt(i))
			}
			, tryEmit: function (t) {
			...
			, recognize: function (t) {
				...
				this.state & (Wt | Ht | 32) && (this.state = Ot), this.state = this.process(e), this.state & (Lt | Ft | Rt | Ht) && this.tryEmit(e)
			}
			, process: function (t) {}
			...
			, process: function (t) {
				var e = this.state
					...
					, n = e & (Lt | Ft)
					, o = this.attrTest(t);
				return n && (i & N || !o) ? e | Ht : n || o ? i & H ? e | Rt : e & Lt ? e | Ft : Lt : 32
			}
		}), v(Yt, jt, {
			defaults: {
				event: "pan"
			...
			, directionTest: function (t) {
				var e = this.options
					...
					, a = t.deltaX
					, r = t.deltaY;
				return o & e.direction || (e.direction & $ ? (o = 0 === a ? z : a < 0 ? V : B, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? z : r < 0 ? j : Y, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
			}
			, attrTest: function (t) {
			...
			, process: function (t) {
				...
				if (this._input = t, !n || !i || t.eventType & (H | N) && !o) this.reset();
				else if (t.eventType & R) this.reset(), this._timer = d(function () {
			...
			, emit: function (t) {
				this.state === Wt && (t && t.eventType & H ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = u(), this.manager.emit(this.options.event, this._input)))
			}
		}), v(qt, jt, {
			defaults: {
				event: "rotate"
			...
			, attrTest: function (t) {
				...
				return i & ($ | X) ? e = t.overallVelocity : i & $ ? e = t.overallVelocityX : i & X && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && c(e) > this.options.velocity && t.eventType & H
			}
			, emit: function (t) {
		...
		Gt.prototype = {
			...
			, recognize: function (t) {
				...
				if (!e.stopped) {
					...
					for (var a = 0; a < n.length;) i = n[a], 2 === e.stopped || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (Lt | Ft | Rt) && (o = e.curRecognizer = i), a++
				}
			}
			, get: function (t) {
...
, function (t) {
			...
			if (!n.hasClass("browser-default")) {
				...
				if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + a).remove()), "destroy" !== e) {
					...
					var y = function (e, i, n) {
						...
						if (r) {
							var l = "";
							return s && (l = ' class="' + s + '"'), "multiple" === n ? d.append(t('<li class="' + o + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : d.append(t('<li class="' + o + a + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable">' + i.html() + "</span></li>")), !0
						}
						"multiple" === n ? d.append(t('<li class="' + o + '"><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : d.append(t('<li class="' + o + a + '"><span class="filtrable">' + i.html() + "</span></li>"))
					};
	...
	, function () {
		...
		function S(t, e) {
			...
			var E, O, L, F, R = n('<div class="clockpicker-tick"></div>');
			if (e.twelvehour)
				for (E = 0; E < 12; E += e.hourstep) O = R.clone(), L = E / 6 * Math.PI, F = y, O.css("font-size", "140%"), O.css({
					left: v + Math.sin(L) * F - x
					, top: v - Math.cos(L) * F - x
				}), O.html(0 === E ? 12 : E), f.append(O), O.on(u, N);
			else
				for (E = 0; E < 24; E += e.hourstep) {
					O = R.clone(), L = E / 6 * Math.PI;
					var W = E > 0 && E < 13;
					F = W ? b : y, O.css({
						left: v + Math.sin(L) * F - x
						, top: v - Math.cos(L) * F - x
					}), W && O.css("font-size", "120%"), O.html(0 === E ? "00" : E), f.append(O), O.on(u, N)
				}
			var H = Math.max(e.minutestep, 5);
			for (E = 0; E < 60; E += H)
				for (E = 0; E < 60; E += 5) O = R.clone(), L = E / 30 * Math.PI, O.css({
					left: v + Math.sin(L) * y - x
					, top: v - Math.cos(L) * y - x
				}), O.css("font-size", "140%"), O.html(m(E)), S.append(O), O.on(u, N);
				...
				if (!i || !(p < y - x || p > y + x)) {
					...
					s && l.append(D.canvas), D.setHand(u, f, !i, !0), a.off(d).on(d, function (t) {
						...
						(i || m) && o === u && s === f && D.setHand(o, s), "hours" === D.currentView ? D.toggleView("minutes", k / 2) : e.autoclose && (D.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
							D.done()
						}, k / 2)), l.prepend(z), clearTimeout(g), D.popover.removeClass("clockpicker-moving"), a.off(d)
					})
				}
			}
			if (l.on(u, function (t) {
				...
				var X = p("circle");
				X.setAttribute("class", "clockpicker-canvas-fg"), X.setAttribute("r", 5), B.appendChild(Y), B.appendChild($), B.appendChild(X), B.appendChild(j), V.appendChild(B), z.append(V), this.hand = Y, this.bg = $, this.fg = X, this.bearing = j, this.g = B, this.canvas = z
			}
			T(this.options.init)
		}
	...
	, function (t, e) {
		...
		return function (t, e, i, n) {
			...
			o.extend(r, n);
			var s, l, c, u, d, h, f, p, m, g, v, y, b, x, w, k, C, S, T, M, I, P, A, D, _, E, O, L, F, R, W, H, N, z, V, B, j, Y, $, X, q, U, Q, Z, G, K, J, tt, et, it, nt, ot, at, rt, st, lt = {
					x: 0
					, y: 0
				}
				, ct = {
				...
				, Ft = null
				, Rt = function () {
					Ft && (o.unbind(document, "mousemove", Rt), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, St("mouseUsed")), Ft = setTimeout(function () {
						Ft = null
					}, 100)
				}
				, Wt = function (t, e) {
				...
				, Zt = {
					...
					, setScrollOffset: function (t, e) {
						ft.x = t, R = ft.y = e, St("updateScrollOffset", ft)
					}
					...
					, init: function () {
						if (!s && !l) {
							var i;
							a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), O = t.className, s = !0, W = o.detectFeatures(), _ = W.raf, E = W.caf, P = W.transform, F = W.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
							...
							e && (a.ui = new e(a, o)).init(), St("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= ze()) && (u = 0), a.currItem = Ne(u), (W.isOldIOSPhone || W.isOldAndroid) && (gt = !1), t.setAttribute("aria-hidden", "false"), r.modal && (gt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === R && (St("initialLayout"), R = L = o.getScrollY());
							var c = "pswp--open ";
							...
							F || o.bind(a.scrollWrap, p, a), Ct("initialZoomInEnd", function () {
								a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && t.focus(), o.bind(document, "keydown", a), W.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", Rt), o.bind(window, "resize scroll", a), St("bindEvents")
					...
					, close: function () {
						s && (s = !1, l = !0, St("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Rt), W.transform && o.unbind(a.scrollWrap, "click", a), Y && o.unbind(window, f, a), St("unbindEvents"), Ve(a.currItem, null, !0, a.destroy))
					}
					, destroy: function () {
						St("destroy"), Fe && clearTimeout(Fe), t.setAttribute("aria-hidden", "true"), t.className = O, x && clearInterval(x), o.unbind(a.scrollWrap, p, a), o.unbind(window, "scroll", a), fe(), Ut(), kt = null
					}
					...
					, goTo: function (t) {
						var e = (t = wt(t)) - u;
						mt = e, u = t, a.currItem = Ne(u), ht -= e, _t(pt.x * ht), Ut(), et = !1, a.updateCurrItem()
					}
					, next: function () {
						a.goTo(u + 1)
					}
					...
					, updateCurrItem: function (t) {
						if (0 !== mt) {
							var e, i = Math.abs(mt);
							if (!(t && 2 > i)) {
								a.currItem = Ne(u), bt = !1, St("beforeChange", mt), i >= 3 && (h += mt + (mt > 0 ? -3 : 3), i = 3);
					...
					, updateSize: function (e) {
						if (!gt && r.modal) {
							var i = o.getScrollY();
							if (R !== i && (t.style.top = i + "px", R = i), !e && yt.x === window.innerWidth && yt.y === window.innerHeight) return;
						...
						if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, jt(), pt.x = dt.x + Math.round(dt.x * r.spacing), pt.y = dt.y, _t(pt.x * ht), St("beforeResize"), void 0 !== h) {
							for (var n, s, l, c = 0; 3 > c; c++) n = k[c], Dt((c + h) * pt.x, n.el.style), l = u + c - 1, r.loop && ze() > 2 && (l = wt(l)), (s = Ne(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && ($e(s, dt), Qe(s), At(s));
							w = !1
						}
				...
				, Te = function (t, e) {
					var i, n, o, s, l = ut[t] + e[t]
						...
						, u = ce.x + e.x
						, d = ce.x - ne.x;
					return i = l > J.min[t] || l < J.max[t] ? r.panEndFriction : 1, l = ut[t] + e[t] * i, !r.allowPanToNext && g !== a.currItem.initialZoomLevel || (tt ? "h" !== it || "x" !== t || X || (c ? (l > J.min[t] && (i = r.panEndFriction, J.min[t], n = J.min[t] - ct[t]), (0 >= n || 0 > d) && ze() > 1 ? (s = u, 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[t] && (i = r.panEndFriction, J.max[t], n = ct[t] - J.max[t]), (0 >= n || d > 0) && ze() > 1 ? (s = u, d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== t) ? void(et || Q || g > a.currItem.fitRatio && (ut[t] += e[t] * i)) : (void 0 !== s && (_t(s, !0), Q = s !== ne.x), J.min.x !== J.max.x && (void 0 !== o ? ut.x = o : Q || (ut.x += e.x * i)), void 0 !== s)
				}
				, Me = function (t) {
					if (!("mousedown" === t.type && t.button > 0)) {
						...
						if (!j || "mousedown" !== t.type) {
							...
							var i = Se(t)
								, n = i.length;
							Z = null, Ut(), Y && 1 !== n || (Y = nt = !0, o.bind(window, f, a), V = rt = ot = B = Q = q = $ = X = !1, it = null, St("firstTouchStart", i), Ot(ct, ut), lt.x = lt.y = 0, Ot(te, i[0]), Ot(ee, te), ne.x = pt.x * ht, oe = [{
								x: te.x
								, y: te.y
							}], N = H = Tt(), Wt(g, !0), fe(), pe()), !G && n > 1 && !et && !Q && (v = g, X = !1, G = $ = !0, lt.y = lt.x = 0, Ot(ct, ut), Ot(Gt, i[0]), Ot(Kt, i[1]), be(Gt, Kt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, K = he(Gt, Kt))
						}
					}
				}
				, Ie = function (t) {
					...
					if (Z) {
						...
						if (0 !== t)
							if (Ot(Gt, Z[0]), Jt.x = Gt.x - te.x, Jt.y = Gt.y - te.y, G && t > 1) {
								...
								0 > n && (n = 0), be(Gt, Kt, se), lt.x += se.x - de.x, lt.y += se.y - de.y, Ot(de, se), ut.x = Et("x", i), ut.y = Et("y", i), V = i > g, g = i, Pt()
							}
							else {
								if (!it) return;
				...
				, Ae = function (t) {
					...
					if (0 === l && (Y = !1, o.unbind(window, f, a), fe(), G ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", G && 2 > l && (G = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Z = null, q || X || et || B)
						if (Ut(), z || (z = De()), z.calculateSwipeSpeed("x"), B)
						...
						if (!et) return "swipe" !== n ? void Le() : void(!Q && g > a.currItem.fitRatio && _e(z))
					}
				}
				, De = function () {
					var t, e, i = {
				...
				, Le = function () {
					...
					e > g ? t = e : g > i && (t = i);
					var n, r = at;
					return ot && !V && !rt && e > g ? (a.close(), !0) : (ot && (n = function (t) {
						Mt((1 - r) * t + r)
			...
			var Fe, Re, We, He, Ne, ze, Ve = function (e, i, n, s) {
					var l;
					Fe && clearTimeout(Fe), He = !0, We = !0, e.initialLayout ? (l = e.initialLayout, e.initialLayout = null) : l = r.getThumbBoundsFn && r.getThumbBoundsFn(u);
					var d = n ? r.hideAnimationDuration : r.showAnimationDuration
						, h = function () {
							Xt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Mt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), St("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), He = !1
						};
						...
						e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, Pt()), qt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
							...
							if (St("initialZoom" + (n ? "Out" : "In")), n) {
								var a = l.w / e.w
									...
									, u = at
									, f = function (e) {
										1 === e ? (g = a, ut.x = l.x, ut.y = l.y - R) : (g = (a - c) * e + c, ut.x = (l.x - r.x) * e + r.x, ut.y = (l.y - R - r.y) * e + r.y), Pt(), s ? t.style.opacity = 1 - e : Mt(u - e * u)
									};
								i ? Qt("initialZoom", 0, 1, d, o.easing.cubic.out, f, h) : (f(1), Fe = setTimeout(h, d + 20))
							}
							else g = e.initialZoomLevel, Ot(ut, e.initialPosition), Pt(), Mt(1), s ? t.style.opacity = 1 : Mt(1), Fe = setTimeout(h, d + 20)
						}, n ? 25 : 90)
					}()
				}
				, Be = {}
			...
			xt("Controller", {
				publicMethods: {
					...
					, initController: function () {
						o.extend(r, Ye, !0), a.items = Re = i, Ne = a.getItemAt, ze = r.getNumItemsFn, r.loop, ze() < 3 && (r.loop = !1), Ct("beforeChange", function (t) {
							var e, i = r.preload
								, n = null === t || t >= 0
								, o = Math.min(i[0], ze())
								, s = Math.min(i[1], ze());
					...
					, setContent: function (t, e) {
						...
						if (l) {
								...
								if (l.loadComplete = function (i) {
										if (s) {
											if (t && t.index === e) {
												...
												i.imageAppended ? !He && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : W.transform && (et || He) ? je.push({
													item: i
													, baseDiv: c
													, img: i.img
													, index: e
							...
							We || e !== u ? At(l) : (tt = c.style, Ve(l, n || l.img)), t.el.innerHTML = "", t.el.appendChild(c)
						}
						else t.el.innerHTML = ""
					}
		...
		return function (t, e) {
			var i, n, o, a, r, s, l, c, u, d, h, f, p, m, g, v, y, b, x = this
				...
				, T = function (t) {
					...
					for (var i, n, o = (t.target || t.srcElement).getAttribute("class") || "", a = 0; a < N.length; a++)(i = N[a]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(), n = !0);
					if (n) {
			...
			x.init = function () {
				e.extend(t.options, S, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen
					, function () {
						...
						C || D(), y && clearInterval(y), e.unbind(document, "mouseout", R), e.unbind(document, "mousemove", F), e.unbind(n, "pswpTap click", T), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
					}), d("destroy", function () {
					...
					, function () {
						var t, i, o, a = function (n) {
							if (n)
								for (var a = n.length, r = 0; a > r; r++) {
									t = n[r], i = t.className;
									for (var s = 0; s < N.length; s++) o = N[s], i.indexOf("pswp__" + o.name) > -1 && (g[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled"))
								}
						};
						a(n.children);
						...
						e.bind(document, "mousemove", F), e.bind(document, "mouseout", R), y = setInterval(function () {
							2 == ++L && x.setIdle(!0)
						}, g.timeToIdle / 2)
...
initPhotoSwipeFromDOM(".mdb-lightbox")
	...
	, function (t) {
		...
		var n, o, a = i("transform")
			...
			, c = /iPad|iPhone|iPod/.test(s) && !t.MSStream
			, u = s.toLowerCase().indexOf("firefox") > -1
			, d = s.indexOf("MSIE ") > -1 || s.indexOf("Trident/") > -1 || s.indexOf("Edge/") > -1
			, h = document.all && !t.atob;

		function f() {
			n = t.innerWidth || document.documentElement.clientWidth, o = t.innerHeight || document.documentElement.clientHeight
		}
		f();
		var p = []
			, m = function () {
				...
				return function (e, i) {
					...
					if (this.$item = e, this.defaults = {
							...
							, onDestroy: null
							, onCoverImage: null
						}, n = JSON.parse(this.$item.getAttribute("data-jarallax") || "{}"), this.options = this.extend({}, this.defaults, n, i), !(!a || l && this.options.noAndroid || c && this.options.noIos)) {
						this.options.speed = Math.min(2, Math.max(-1, parseFloat(this.options.speed)));
						var o = this.options.elementInViewport;
						o && "object" == typeof o && void 0 !== o.length && (o = o[0]), !o instanceof Element && (o = null), this.options.elementInViewport = o, this.instanceID = t++, this.image = {
		...
		function v(e) {
			t.requestAnimationFrame(function () {
				"scroll" !== e.type && f();
				for (var t = 0, i = p.length; t < i; t++) "scroll" !== e.type && (p[t].coverImage(), p[t].clipContainer()), p[t].onScroll()
			})
		}
		m.prototype.css = function (e, i) {
			...
			for (var n = 0, o = t.$item; null !== o && o !== document && 0 === n;) {
				var a = t.css(o, "-webkit-transform") || t.css(o, "-moz-transform") || t.css(o, "transform");
				a && "none" !== a && (n = 1, t.css(t.image.$container, {
			...
			if (this.image.width && this.image.height) {
				var t = this.image.$container.getBoundingClientRect()
					...
					, h = 0
					, f = 0;
				l && (c = s < 0 ? s * Math.max(i, o) : s * (i + o), s > 1 ? d = Math.abs(c - o) : s < 0 ? d = c / s + Math.abs(c) : d += Math.abs(o - i) * (1 - s), c /= 2), (u = d * a / r) < e && (d = (u = e) * r / a), l ? (h = n + (e - u) / 2, f = (o - d) / 2) : (h = (e - u) / 2, f = (i - d) / 2), "absolute" === this.image.position && (h -= n), this.parallaxScrollDistance = c, this.css(this.image.$item, {
					width: u + "px"
					, height: d + "px"
					, marginLeft: h + "px"
					, marginTop: f + "px"
			...
			if (this.image.width && this.image.height) {
				var e = this.$item.getBoundingClientRect()
					...
					, s = e;
				if (this.options.elementInViewport && (s = this.options.elementInViewport.getBoundingClientRect()), this.isElementInViewport = s.bottom >= 0 && s.right >= 0 && s.top <= o && s.left <= n, t || this.isElementInViewport) {
					var l = Math.max(0, i)
						, c = Math.max(0, a + i)
						, u = Math.max(0, -i)
						, d = Math.max(0, i + a - o)
						, h = Math.max(0, a - (i + a - o))
						, f = Math.max(0, -i + o - a)
						, p = 1 - 2 * (o - i) / (o + a)
						, m = 1;
					if (a < o ? m = 1 - (u || d) / a : c <= o ? m = c / o : h <= o && (m = h / o), "opacity" !== this.options.type && "scale-opacity" !== this.options.type && "scroll-opacity" !== this.options.type || (r.transform = "", r.opacity = m), "scale" === this.options.type || "scale-opacity" === this.options.type) {
						var g = 1;
					...
					if ("scroll" === this.options.type || "scroll-opacity" === this.options.type) {
						...
						"absolute" === this.image.position && (v -= i), r.transform = "translateY(" + v + "px)"
					}
		...
		}, g(t, "scroll", v), g(t, "resize", v), g(t, "orientationchange", v), g(t, "load", v);
		var y = function (t) {
			("object" == typeof HTMLElement ? t instanceof HTMLElement : t && "object" == typeof t && null !== t && 1 === t.nodeType && "string" == typeof t.nodeName) && (t = [t]);
			for (var e, i = arguments[1], n = Array.prototype.slice.call(arguments, 2), o = t.length, a = 0; a < o; a++)
				if ("object" == typeof i || void 0 === i ? t[a].jarallax || (t[a].jarallax = new m(t[a], i)) : t[a].jarallax && (e = t[a].jarallax[i].apply(t[a].jarallax, n)), void 0 !== e) return e;
			return t
		};
		y.constructor = m;
		var b = t.jarallax;
	...
	, function (t) {
				...
				this.url = e, this.options_default = {
					...
					for (var e = 1; e < arguments.length; e++)
						if (arguments[e])
							for (var i in arguments[e]) arguments[e].hasOwnProperty(i) && (t[i] = arguments[e][i]);
					return t
				}({}, this.options_default, i), this.videoID = this.parseURL(e), this.videoID && (this.ID = t++, this.loadAPI(), this.init())
			}
		}();
		n.prototype.parseURL = function (t) {
			var e, i = !(!(e = t.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== e[1].length) && e[1]
				, n = function (t) {
			...
			n.$iframe ? e(n.$iframe) : n.onAPIready(function () {
				...
				if (n.$iframe || ((o = document.createElement("div")).style.display = "none"), "youtube" === n.type) {
					...
					if (h) {
						...
						f.setAttribute("id", n.playerID), o.appendChild(f), document.body.appendChild(o)
					}
					n.player = n.player || new t.YT.Player(n.playerID, n.playerOptions), h && (n.$iframe = document.getElementById(n.playerID), n.videoWidth = parseInt(n.$iframe.getAttribute("width"), 10) || 1280, n.videoHeight = parseInt(n.$iframe.getAttribute("height"), 10) || 720)
				}
				"vimeo" === n.type && (n.playerOptions = "", n.playerOptions += "player_id=" + n.playerID, n.playerOptions += "&autopause=0", n.options.controls || (n.playerOptions += "&badge=0&byline=0&portrait=0&title=0"), n.playerOptions += "&autoplay=" + (n.options.autoplay ? "1" : "0"), n.playerOptions += "&loop=" + (n.options.loop ? 1 : 0), n.$iframe || (n.$iframe = document.createElement("iframe"), n.$iframe.setAttribute("id", n.playerID), n.$iframe.setAttribute("src", "https://player.vimeo.com/video/" + n.videoID + "?" + n.playerOptions), n.$iframe.setAttribute("frameborder", "0"), o.appendChild(n.$iframe), document.body.appendChild(o)), n.player = n.player || new Vimeo.Player(n.$iframe), n.player.getVideoWidth().then(function (t) {
					...
					n.videoHeight = t || 720
				}), n.player.setVolume(n.options.mute ? 0 : 100), n.player.on("timeupdate", function (t) {
					a || n.fire("started", t), a = 1, n.options.endTime && n.options.endTime && t.seconds >= n.options.endTime && (n.options.loop ? n.play(n.options.startTime) : n.pause())
				...
				if ("local" === n.type) {
					if (!n.$iframe)
						for (var p in n.$iframe = document.createElement("video"), n.options.mute && (n.$iframe.muted = !0), n.options.loop && (n.$iframe.loop = !0), n.$iframe.setAttribute("id", n.playerID), o.appendChild(n.$iframe), document.body.appendChild(o), n.videoID) r = n.$iframe, s = n.videoID[p], l = "video/" + p, c = void 0, (c = document.createElement("source")).src = s, c.type = l, r.appendChild(c);
					var m;
					n.player = n.player || n.$iframe, i(n.player, "playing", function (t) {
						m || n.fire("started", t), m = 1
		...
		n.prototype.loadAPI = function () {
			if (!o || !a) {
				var e = "";
				if ("youtube" !== this.type || o || (o = 1, e = "//www.youtube.com/iframe_api"), "vimeo" !== this.type || a || (a = 1, e = "//player.vimeo.com/api/player.js"), e) {
		...
		n.prototype.onAPIready = function (e) {
			if ("youtube" === this.type && ("undefined" != typeof YT && 0 !== YT.loaded || r ? "object" == typeof YT && 1 === YT.loaded ? e() : l.done(function () {
				...
				if ("undefined" != typeof Vimeo || s) "undefined" != typeof Vimeo ? e() : c.done(function () {
					e()
				});
				else {
					s = 1;
					var i = setInterval(function () {
						"undefined" != typeof Vimeo && (clearInterval(i), c.resolve("done"), e())
					}, 20)
				}
				"local" === this.type && e()
		}, t.VideoWorker = n
